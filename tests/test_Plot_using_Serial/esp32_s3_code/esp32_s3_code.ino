...
void setup() {
  ...
  // Wire.setClock(100000);  // Set I2C frequency to 100 kHz

  // // Enable software pull-up resistors for SDA and SCL
...
void loop() {
  ...
  readSerialData();
  // if (millis() - last_time > 10) {  // 115200 baudrate is too high for SoftwareSerial port.
